...
phc_ctl /dev/${PHC_PHYSICAL} set 0
linuxptp/ptp4l -2 -H -i ${INTERFACE} --socket_priority=4 --tx_timestamp_timeout=40 -f /etc/gPTP-domain1.cfg &
...
linuxptp/phc2sys -s /dev/${PHC_PHYSICAL} -c CLOCK_AUX0 --step_threshold=1 --transportSpecific=1 -O0 &
